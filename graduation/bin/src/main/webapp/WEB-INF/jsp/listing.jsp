...
<html>
	...
	<body>
		...
		<form id="form" action="${pageContext.request.contextPath}/form" enctype="multipart/form-data" method="post">
			<div id="imgList">
				<!-- 将转码后的文件聚合在此处传到后台处理 -->
			</div>
			<ul>
				<li>
					<!-- 出租方式 -->
					<label>出租方式</label>
					<input name="rentalMethod" type="radio" value="0" />整租
				...
				<li>
					<!-- 小区名称 -->
					<label>小区名称</label>
					<input class="ordinary" name="communityName" placeholder="请输入小区名称" />
				</li>
				<li>
					<!-- 户型 -->
					<label>户&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型</label>
				...
				<li>
					<label>楼&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;层</label>
					<input class="ordinary" name="floor" type="text" placeholder="请输入楼层" />
				</li>
				<li>
					<label>建筑面积</label>
					<input class="ordinary" name="area" type="text" placeholder="请输入楼层" />
				</li>
				<li>
					<label>租&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金</label>
					<input class="ordinary" name="rent" type="text" placeholder="请输入租金" />
				</li>
				<li>
					<label>配套设施</label>
				...
				<li>
					<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题</label>
					<input class="ordinary" name="title" type="text" placeholder="请输入标题" />
				</li>
				<li class="textarea">
				...
				<li>
					<label>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</label>
					<input class="ordinary" name="userName" type="text" placeholder="请输入姓名" />
				</li>
				<li>
					<label>手&nbsp;&nbsp;机&nbsp;&nbsp;号</label>
					<input class="ordinary" name="phone" type="text" placeholder="请输入手机号" />
				</li>
			</ul>
			<div class="send">
